...
- Цена/доход: чем выше реальный доход (после комиссии), тем лучше. Выше средней = +20, ниже = -10
- Дедлайн: >3 дней = +10, <24ч = -20
- Конкуренция: 0 ставок = +20, >5 ставок = -15
- Уникальность: <60% = +10, >80% = -5
- Наличие файлов/методички: +10

ВАЖНО: При оценке цены ориентируйся на "Наш доход после комиссии" — это реальная сумма, которую мы получим.
Чем выше доход — тем выше score (при прочих равных).
