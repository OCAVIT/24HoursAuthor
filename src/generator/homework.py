...
async def generate(
    ...
    """Сгенерировать контрольную работу / решение задач / ответы на вопросы."""
...
def _build_prompt(
    ...
    """Построить промпт для генерации контрольной."""
    parts = [
        f"Выполни задание: \"{title}\"",
    ...
    parts.append(
        "\nОформи ответ структурированно: каждый вопрос/задачу отдельно с заголовком. "
