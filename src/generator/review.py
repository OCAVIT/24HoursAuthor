...
PLAN_INSTRUCTIONS = (
    "Раздели рецензию на логические части: "
    "актуальность темы, оценка структуры работы, "
    "анализ содержания, достоинства работы, "
    "замечания и рекомендации, общий вывод и итоговая оценка."
)
...
async def generate(
    ...
    """Сгенерировать рецензию пошагово: план → разделы → расширение."""
